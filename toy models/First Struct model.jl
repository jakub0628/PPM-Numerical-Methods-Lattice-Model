...
begin
	@show VERSION
	using Plots, LinearAlgebra, Distributions, Parameters, BenchmarkTools, PlutoUI
end

# ╔═╡ b21b9631-3b88-4530-9466-08ae2bade989
TableOfContents(title="Sections:",indent=true)

# ╔═╡ 6f85c52b-b1a0-416d-8e3d-936565eff6d7
begin
	TT = Array{Int64}(undef,Int(1e7/1e4))
	for i in 1:1e7
		if i%1e4==0
			TT[Int(i/1e4)]=i
		end
...
begin
	...
	mutable struct Grid
		...
		J::Float64 #Couplign strength
		s::Matrix{Vector{Float64}} #grid of the spins
	
		function Grid(; m=100,n=100,d=2,β=1e2,Glauber=false,J=1) #creates and fills the m*n grid of d-dimensional spins using the default values
			new(m,n,d,β,Glauber,J,[spin(d) for i in 1:m, j in 1:n]) 
		end
	end
	...
	function neighbours(S::Grid,i::Int,j::Int) #obtains the sum of the neighbours for the energy calculation
		...
		return NN+SS+WW+EE #return sum of the neighbours
	end
...
manifest_format = "2.0"
project_hash = "8f45ba55e1685f013168ad1875f71336d7c9d3c5"
